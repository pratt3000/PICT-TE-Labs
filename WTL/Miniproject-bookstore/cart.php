   	...
   	<form action="cart.php" method="post">
	   	<table class="table" style="color:white;">
			...
			<tr>
				...
				<td><input type="text" value="<?php echo $qty; ?>" size="2" name="<?php echo $isbn; ?>" style="color:black;"></td>
...
<?php
		...
		echo "<p class=\"text-warning\" style='color:white;'>Your cart is empty! Please make sure you add some books in it!</p>";
	}
